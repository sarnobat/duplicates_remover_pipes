...
cd ~/duplicates_remover_pipes && cat /Unsorted/new/Photos/duplicates.txt | head -2200  | groovy duff_exists.groovy | groovy duff_size.groovy | grep -v corrupt | grep -v thumbnail | groovy duff_json.groovy | groovy array2images.groovy | tee index.html
